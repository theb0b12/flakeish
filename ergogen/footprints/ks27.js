...
fp.push(`(pad "1" smd rect (at -7.675 ${flipN(flip, 4.7)} ${flipR(flip, p.r + 0)}) (size 2.6 2.6) (layers "${(flip ? "F" : "B")}.Cu" "${(flip ? "F" : "B")}.Paste" "${(flip ? "F" : "B")}.Mask")  ${p.to})`);
...
fp.push(`(pad "2" smd rect (at 5.875 ${flipN(flip, 5.75)} ${flipR(flip, p.r + 0)}) (size 2.6 2.6) (layers "${(flip ? "F" : "B")}.Cu" "${(flip ? "F" : "B")}.Paste" "${(flip ? "F" : "B")}.Mask")  ${p.from})`);
